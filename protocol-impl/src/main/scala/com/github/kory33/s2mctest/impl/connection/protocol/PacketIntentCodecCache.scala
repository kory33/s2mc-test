...
import com.github.kory33.s2mctest.impl.connection.packets.PacketDataCompoundTypes.Position
...
class PacketIntentCodecCache(using ByteCodec[Position]) {
  import com.github.kory33.s2mctest.impl.connection.packets.PacketIntent.Handshaking.ClientBound.*
