...
object v1_14_4 extends WithVersionNumber {
  ...
  val protocolVersion: VarInt = VarInt(498)
  ...
  val playProtocol = Protocol(
    ...
    PacketIdBindings((
      ...
      0x46 -> ByteCodec[EntityEquipment_VarInt[VersionSpecificSlot]],
      ...
      0x5c -> ByteCodec[AcknowledgePlayerDigging],
    ))
  )
  // format: on
