...
object v1_16_1 extends WithVersionNumber {
  ...
  val playProtocol = Protocol(
    PacketIdBindings((
      ...
      0x1e -> ByteCodec[CraftingBookData],
      0x1f -> ByteCodec[NameItem],
      0x20 -> ByteCodec[ResourcePackStatus],
      0x21 -> ByteCodec[AdvancementTab],
      0x22 -> ByteCodec[SelectTrade],
      0x23 -> ByteCodec[SetBeaconEffect],
      ...
      0x2b -> ByteCodec[ArmSwing],
      0x2c -> ByteCodec[SpectateTeleport],
      0x2d -> ByteCodec[PlayerBlockPlacement_insideblock],
      0x2e -> ByteCodec[UseItem],
    )),
    PacketIdBindings((
      ...
      0x21 -> ByteCodec[ChunkData_Biomes3D_bool],
      0x22 -> ByteCodec[Effect],
      0x23 -> ByteCodec[Particle_f64],
      0x24 -> ByteCodec[UpdateLight_WithTrust],
      0x25 -> ByteCodec[JoinGame_WorldNames],
      0x26 -> ByteCodec[Maps],
      0x27 -> ByteCodec[TradeList_WithRestock],
      ...
      0x3a -> ByteCodec[Respawn_WorldName],
