...
import io.github.kory33.s2mctest.impl.connection.codec.decode.{PrimitiveDecodes, VarNumDecodes}
...
object ByteCodecs {
  ...
  import io.github.kory33.s2mctest.impl.connection.codec.decode.PrimitiveDecodes.*
  import io.github.kory33.s2mctest.impl.connection.codec.encode.PrimitiveEncodes.*
  ...
  import io.github.kory33.s2mctest.core.generic.conversions.AutoWidenFunctor.given
  ...
  object Common {
    ...
    given ByteCodec[EntityEquipments] = {
      import io.github.kory33.s2mctest.core.generic.extensions.MonadValueExt.repeatWhileM
