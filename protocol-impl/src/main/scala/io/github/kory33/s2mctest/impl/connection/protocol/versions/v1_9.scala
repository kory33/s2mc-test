...
object v1_9 extends WithVersionNumber {
  ...
  val protocolVersion: VarInt = VarInt(107)
  ...
  val playProtocol = Protocol(
    PacketIdBindings((
      ...
      0x16 -> ByteCodec[ResourcePackStatus_hash],
    ...
    PacketIdBindings((
      ...
      0x19 -> ByteCodec[NamedSoundEffect_u8],
      ...
      0x46 -> ByteCodec[UpdateSign],
      0x47 -> ByteCodec[SoundEffect_u8],
      0x48 -> ByteCodec[PlayerListHeaderFooter],
      0x49 -> ByteCodec[CollectItem_nocount],
      0x4a -> ByteCodec[EntityTeleport_f64],
      0x4b -> ByteCodec[EntityProperties],
      0x4c -> ByteCodec[EntityEffect],
    ))
  )
  // format: on
